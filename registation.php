...
<body class="html front not-logged-in no-sidebars page-frontpage i18n-uk" style="background-color: #e4d5f5;">
			...
			<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
				<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
					<form class="login100-form validate-form flex-sb flex-w">
						...
						<div class="wrap-input100 validate-input" id="email-div" data-validate = "Пошта введена у неправильному форматі">
						...
						<div class="wrap-input100 validate-input" id="password-div" data-validate = "Пароль введено у неправильному форматі">
							<input class="input100" type="password" name="pass" id="password">
							<span class="focus-input100"></span>
						</div>
	
						<div class="container-login100-form-btn m-t-17">
							<button class="login100-form-btn" id="reg_btn">
								Зареєструватись
							</button>
						</div>
						...
						<div class="w-full text-center p-t-55">
							...
							<a href="authorization.php" class="txt2 bo1">
								Авторизуватись зараз! 
							</a>
						</div>
					</form>
				</div>
	...
	<!--===============================================================================================-->
		...
		<script>		
			...
			document.querySelector('#reg_btn').addEventListener('click', (event) => {
				...
				if(validation_check()) {
			        ...
			        success: function (data) {
			            if (data == 'Ok') {
			                window.location.href = window.location.origin + '/authorization.php';
			            }
			        }
			    });
				}
